...
const API_KEY = process.env.NEXT_PUBLIC_HF_TOKEN;
...
export async function sendMessageToAI(
  ...
  try {
    ...
    const thinkEndMatch = aiMessage.match(/<\/think>\s*([\s\S]*)/);
